...
class SearchAuthorWidgetAsync extends StatefulWidget {
  const SearchAuthorWidgetAsync({super.key, required this.customClass});

  final dynamic customClass;
  @override
  State<SearchAuthorWidgetAsync> createState() =>
      _SearchAuthorWidgetAsyncState();
}
